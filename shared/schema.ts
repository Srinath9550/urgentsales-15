...
export const projects = pgTable("projects", {
  ...
  floorPlanUrls: text("floor_plan_urls").array(),
  specificationUrls: text("specification_urls").array(),
  youtubeUrl: text("youtube_url"),
  bhk2Sizes: text("bhk2_sizes").array(),
  bhk3Sizes: text("bhk3_sizes").array(),
  locationAdvantages: text("location_advantages"),
  loanAmount: text("loan_amount"),
  interestRate: text("interest_rate"),
  loanTenure: text("loan_tenure"),
  premiumFeatures: text("premium_features"),
  exclusiveServices: text("exclusive_services"),
  affordabilityFeatures: text("affordability_features"),
  financialSchemes: text("financial_schemes"),
  commercialType: text("commercial_type"),
  businessAmenities: text("business_amenities"),
  launchDate: text("launch_date"),
  launchOffers: text("launch_offers"),
  expectedCompletionDate: text("expected_completion_date"),
  constructionStatus: text("construction_status"),
  saleDeadline: text("sale_deadline"),
  urgencyReason: text("urgency_reason"),
  discountOffered: text("discount_offered"),
  highlightFeatures: text("highlight_features"),
  accolades: text("accolades"),
  listingDate: text("listing_date"),
  specialIntroOffer: text("special_intro_offer"),
...
export const insertProjectSchema = createInsertSchema(projects)
  ...
  .extend({
    ...
    specificationUrls: z.array(z.string()).default([]),
    bhk2Sizes: z.array(z.string()).default([]),
    bhk3Sizes: z.array(z.string()).default([]),
